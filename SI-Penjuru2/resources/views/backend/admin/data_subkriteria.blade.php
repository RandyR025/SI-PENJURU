  ...
  <div class="row">
    <table class="table table-hover" id="datatable">
      ...
      <tr>
          ...
          <td>
          <button value="{{ $item->kode_kriteria }}" class="btn btn-icon btn-icon-only btn-outline-secondary mb-1 edit_subkriteria" type="button" data-bs-placement="top" titte data-bs-original-title="Edit" data-bs-toggle="tooltip">
        ...
        <div class="modal-body">
          <form action="" id="subkriteria_form">
            ...
            <div class="mb-3">
              ...
              <span class="text-danger error-text namasubkriteria_error"></span>
