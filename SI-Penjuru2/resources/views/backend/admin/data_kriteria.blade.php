        ...
        <div class="modal-body">
          <form action="" id="kriteria_form">
            <div class="mb-3">
              ...
              <span class="text-danger error-text kodekriteria_error"></span>
            </div>
            <div class="mb-3">
              <label class="form-label">Name</label>
              <input id="edit_namakriteria" type="text" class="namekriteria form-control" value="" name="nama_kriteria" />
              <span class="text-danger error-text namakriteria_error"></span>
